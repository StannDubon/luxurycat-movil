...
require_once('../../libs/fpdf185/fpdf.php');
...
class Report2 extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/luxurycat-movil/luxurycat-web/views/public/';
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['usuario_id'])) {
            ...
            $this->setTitle('Luxury Cat - Reporte', true);
    ...
    */
    public function header()
    {
       ...
       // $this->image('../../images/Group 11.png', 15, 15, 20);
        // Se establece el titulo del sitio
        $this->setFont('Arial', 'B', 24);
        $this->cell(180, 10, $this->encodeString('Luxurycat'), 0, 1, 'L');
        // Se ubica el título.
        $this->cell(20);
    ...
    */
    public function footer()
    {
        ...
        $this->cell(0, 10, $this->encodeString('Usuario: ' . $_SESSION['usuario_usuario']), 0, 1, 'C');
